...
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN P16 [get_ports {button_0[0]}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {button_0[1]}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {button_0[2]}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {button_0[3]}];  # "BTNR"
set_property PACKAGE_PIN T18 [get_ports {button_0[4]}];  # "BTNU"
