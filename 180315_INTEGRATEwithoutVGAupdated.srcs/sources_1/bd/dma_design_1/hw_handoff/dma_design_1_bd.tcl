...
proc create_root_design { parentCell } {
  ...
  set button_0 [ create_bd_port -dir I -from 4 -to 0 button_0 ]
  ...
  set audio_testbench_0 [ create_bd_cell -type ip -vlnv sfu.ca:user:audio_testbench:1.1 audio_testbench_0 ]
  ...
  # Create instance: try_vga_0, and set properties
  set block_name try_vga
  set block_cell_name try_vga_0
  if { [catch {set try_vga_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $try_vga_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net Debounce_0_result [get_bd_pins Debounce_0/result] [get_bd_pins axi_gpio_0/gpio_io_i]
  ...
  connect_bd_net -net Net1 [get_bd_pins fifo_generator_0/m_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins try_vga_0/clk25]
  ...
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins audio_testbench_0/Notes_Value] [get_bd_pins axi_gpio_3/gpio_io_o]
  connect_bd_net -net axi_gpio_4_gpio_io_o [get_bd_pins audio_testbench_0/Ampitude_Value] [get_bd_pins axi_gpio_4/gpio_io_o]
  connect_bd_net -net axi_vdma_0_mm2s_introut [get_bd_pins axi_vdma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net button_0_1 [get_bd_ports button_0] [get_bd_pins Debounce_0/button]
  connect_bd_net -net fifo_generator_0_m_axis_tdata [get_bd_pins fifo_generator_0/m_axis_tdata] [get_bd_pins try_vga_0/pixel_data]
  connect_bd_net -net fifo_generator_0_m_axis_tvalid [get_bd_pins fifo_generator_0/m_axis_tvalid] [get_bd_pins try_vga_0/tvalid]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins try_vga_0/aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Debounce_0/clk] [get_bd_pins LSFR_0/clock] [get_bd_pins audio_testbench_0/clk_100] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins fifo_generator_0/s_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins LSFR_0/reset] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins fifo_generator_0/s_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net try_vga_0_blue [get_bd_ports blue_0] [get_bd_pins try_vga_0/blue]
  connect_bd_net -net try_vga_0_fsync_outp [get_bd_pins axi_vdma_0/mm2s_fsync] [get_bd_pins try_vga_0/fsync_outp]
  connect_bd_net -net try_vga_0_green [get_bd_ports green_0] [get_bd_pins try_vga_0/green]
  connect_bd_net -net try_vga_0_hsync [get_bd_ports hsync_0] [get_bd_pins try_vga_0/hsync]
  connect_bd_net -net try_vga_0_red [get_bd_ports red_0] [get_bd_pins try_vga_0/red]
  connect_bd_net -net try_vga_0_tready [get_bd_pins fifo_generator_0/m_axis_tready] [get_bd_pins try_vga_0/tready]
  connect_bd_net -net try_vga_0_vsync [get_bd_ports vsync_0] [get_bd_pins try_vga_0/vsync]
